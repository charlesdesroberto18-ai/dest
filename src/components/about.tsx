    ...
    <section id="sobre" className="py-12 lg:py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold text-foreground mt-2 mb-3 text-balance">
            A Casa do Sabor em Tubarão
          </h2>
          <p className="text-foreground/80 text-sm max-w-xl mx-auto">
            Tradição e qualidade em cada prato servido
          </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-extrabold text-foreground text-sm mb-0.5">{feature.title}</h4>
